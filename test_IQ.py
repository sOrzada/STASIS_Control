...
for a in range(14):
    STASIS_Control.STASIS_System.Modulator.I_values = [pow(2,a+1)-1]*STASIS_Control.STASIS_System.Modulator.number_of_channels
    STASIS_Control.STASIS_System.Modulator.Q_values = [0]*STASIS_Control.STASIS_System.Modulator.number_of_channels
...
for a in range(14):
    STASIS_Control.STASIS_System.Modulator.I_values = [0]*STASIS_Control.STASIS_System.Modulator.number_of_channels
    STASIS_Control.STASIS_System.Modulator.Q_values = [pow(2,a+1)-1]*STASIS_Control.STASIS_System.Modulator.number_of_channels
    STASIS_Control.STASIS_System.Modulator.Amp_state =[0]*STASIS_Control.STASIS_System.Modulator.number_of_channels
    data=STASIS_Control.STASIS_System.Modulator.return_byte_stream()
    STASIS_Control.STASIS_System.SPI.send_bitstream(data)
    sleep(1)
